...
import sys
sys.path.insert(1,"/mnt/ilustre/users/huimin.zhang/script")
...
from otu_significance import (get_sample_cats, get_sample_indices, 
                              get_cat_sample_groups, group_significance_row_generator,
                              group_significance_output_formatter,
                              sort_by_pval, run_group_significance_test,
                              TWO_GROUP_TESTS, GROUP_TEST_CHOICES)
...
def main():
    ...
    test_stats, pvals, means, stds = run_group_significance_test(
        data_feed, opts.test,
    ...
    lines = group_significance_output_formatter(bt, test_stats, pvals,
                                                fdr_pvals, bon_pvals, means, stds, cat_sam_indices, md_key=opts.metadata_key)
